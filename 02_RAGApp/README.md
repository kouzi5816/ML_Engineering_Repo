...
## 🔗 デモURL
- Streamlit Cloud：https://mlengineeringrepo-k9rvceybruxi3konnrs8fh.streamlit.app/
- Cloud Run：https://rag-app-724625460069.asia-northeast1.run.app
...
[RecursiveCharacterTextSplitter でチャンク分割]
      ↓
[Gemini text-embedding-001 でベクトル化]
      ↓
[ChromaDB（インメモリ）に保存]
      ↓
...
## 📈 今後の拡張予定
- [x] Docker化とCloud Runへのデプロイ（Month 3完了）
